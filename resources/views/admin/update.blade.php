        ...
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal" method="POST" enctype="multipart/form-data"
                    action="{{url('shop/update')}}/<?= base64_encode($shop->id) ?>">
                    @csrf
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="name">Shop Name:</label>
                        <div class="col-sm-10">
                            <input value="{{$shop->name}}" type="text" required class="form-control" name="name"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input value="{{$shop->email}}" type="email" required class="form-control" name="email"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="custom-file">
                                <input value="{{$shop->image}}" type="file" class="custom-file-input" id="customFile"
                                    name="filename">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea required name="description" class="form-control" id="description" cols="2"
                                rows="1">{{$shop->description}}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="phoneNumber">Phone number:</label>
                        <div class="col-sm-10">
                            <input required value="{{$shop->phoneNumber}}" type="text" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input required type="text" value="{{$shop->address}}" class="form-control" id="address"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input required type="text" class="form-control" value="{{$shop->street}}" id="street"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input required type="text" class="form-control" value="{{$shop->city}}" id="city"
                    ...
                    <div class="form-group">
                        <table class="col-sm-10 table table-hover table-bordered ">
                            ...
                            <tbody>
                                ...
                                @foreach($shop->shopFunctionalTimings as $workDays)
                                <tr>
                                    <td>
                                        {{$workDays->days}}
                                        <input type="hidden" name="workingDaysId[]" value="{{$workDays->id}}">
                                        <input type="hidden" name="days[]" value="{{$workDays->days}}">
                                    </td>
                                    <td> <input type="time" value="{{$workDays->startTime}}" name="starttime[]"
                                            class="form-control" id="StartTime_1" placeholder="Enter Start Time">
                                    </td>
                                    <td> <input type="time" value="{{$workDays->endTime}}" name="endtime[]"
                                            class="form-control" id="endTime_1" placeholder="Enter End Time">
                                    </td>
                                </tr>
                                @endforeach
                                @else
                                ...
                                <td>
                                    ...
                                    <input type="hidden" name="break_id" value="{{$shop->shopBreakTimings->id}}">
                                </td>
                                <td> <input type="time" name="breakstarttime"
                                        value="{{$shop->shopBreakTimings->startTime}}" class="form-control"
                                        id="StartTime_8" placeholder="Enter Start Time">
                                </td>
                                <td> <input type="time" name="breakendtime" value="{{$shop->shopBreakTimings->endTime}}"
                                        class="form-control" id="endTime_8" placeholder="Enter End Time">
                                </td>
                                @else
                                <tr>
                                    <td>
...
$(function() {
    ...
    if (ImageName == '') {
        ...
        $(".custom-file-input").siblings(".custom-file-label").addClass("selected").html(ImageName);
    }
});
